...
function loadLocalStorageData() {
    const fields = [
        ...
        'firstName', 'lastName', 'address', 'phone', 'email', 'companyLogo'
    ];
...
function validateField(id, errorMessage, pattern) {
    ...
    const errorField = document.getElementById(`error${capitalizeFirstLetter(id)}`);
...
function displaySuccessMessage() {
    ...
    successMsg.innerHTML = 'Successfully saved your changes';
